...
class TestSigner(unittest.TestCase):
    ...
    def test_json_string_signing(self):
        ...
        mock = requests_mock.Mocker()
        mock.post('https://example.com/perkeep/camli/sig/sign', content=out_str)
        ...
        self.assertDictEqual(json.loads(in_dict['json'][0]), json.loads(in_str))
    ...
    def test_verification_invalid(self):
        ...
        mock.post('https://example.com/perkeep/camli/sig/verify',
                  text='{"signatureValid": false,"errorMessage": "Obvious fake!"}')
