...
class UploadHelperTest(unittest.TestCase):
    ...
    def test_uploadhelper(self):
        ...
        response = '{"got":[{"filename":"afile", "fileref":"sha224-aaaabbbb"}]}'

        mock = requests_mock.Mocker()
        mock.post('https://example.com/perkeep/', text=response)

        with mock:
            fileref = self.uploadhelper.upload_file('afile', file, '2010-01-02T10:20:30Z')
        ...
        self.assertTrue(found_modtime, 'modtime was not found in multipart data')
